...
export default function FamilyFraudDetectionPage() {
  ...
  useEffect(() => {
    if (user && user.role !== 'FAMILY') router.push('/senior')
  }, [user, router])
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header — matches family dashboard green style */}
        ...
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-green-200 text-sm">Check messages your senior received · {user?.name}</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <button onClick={() => router.push('/family')} className="text-green-200 hover:text-white text-sm">
              ← Back to Dashboard
            </button>
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-5">
        ...
        <div className="card flex items-start gap-3">
          ...
          <div>
            <p className="font-semibold text-gray-800">Check a suspicious message on behalf of your senior</p>
            <p className="text-sm text-gray-500 mt-0.5">
              Paste any combination of the email, text message, or phone number they received.
              Our AI will check it for scam patterns. Nothing is required.
            </p>
          </div>
        </div>
        ...
        <div className="flex gap-5">
            ...
            <div className="card space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 bg-gray-50 resize-none"
                />
              </div>
              ...
              <div className="flex gap-3 pt-1">
                <button
                  ...
                  className="flex-1 py-2.5 px-6 rounded-xl bg-green-700 text-white text-sm font-semibold hover:bg-green-800 disabled:opacity-40 disabled:cursor-not-allowed transition flex items-center justify-center gap-2"
                >
                  {loading ? (
          ...
          <div className="w-80 flex-shrink-0 space-y-4">
              ...
              <div className={`card border-2 ${riskBg(result.risk_level)} space-y-4`}>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className="text-3xl">{result.label === 'SCAM' ? '🚨' : '✅'}</span>
                    <div>
                ...
                <div>
                  <p className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Detection Signals</p>
            ...
            <div className="card bg-green-50 border border-green-100">
              <p className="text-xs font-bold text-green-700 mb-1">🛡️ How to help your senior</p>
              <p className="text-xs text-green-700">
                If this is flagged as a scam, advise them not to respond, click any links, or call back.
                Contact the real organization directly using a number from their official website.
              </p>
            </div>
          </div>
        </div>
